...
for col in merged_df.columns:
    if 'Price' in col:
        merged_df[col] = merged_df[col].apply(convert_to_decimal)

merged_df.reset_index(inplace=True)

merged_df.to_csv('merged_commodity_data_decimal.csv', index=False)

print("Merged data has been saved to 'merged_commodity_data_decimal.csv'")
