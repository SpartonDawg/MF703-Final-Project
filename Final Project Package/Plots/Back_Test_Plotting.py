...
covar_opt_portfolio_returns_df = pd.read_csv(r"portfolio_returns_covar_data_AQR.csv")
...
equal_portfolio_returns_df = pd.read_csv(r"portfolio_returns_equal_AQR.csv")
