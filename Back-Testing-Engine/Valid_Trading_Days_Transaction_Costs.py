#MF703 Final Project
#Trading Days Identification and Transaction Costs
#Author: Jim Burrill
...
def calc_net_returns(df, fwd_daily_return_col, position_col):
    '''Calculates the strategy return for the given data, including a transaction cost of 5 bps'''
    
    transaction_costs = 0.0005
    copy_df = df.copy()
    copy_df['Position Scaled Return'] = 1+(copy_df[fwd_daily_return_col] * (1 - transaction_costs) * copy_df[position_col] * copy_df['Tradeable Day'])
