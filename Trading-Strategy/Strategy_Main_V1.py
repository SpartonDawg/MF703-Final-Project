...
import Covariance_V1 as Covariance_Optimization
...
def Back_Tester():
    ...
    print(commodity_prices_df)
    print(BCOM_prices_df)
    ...
    WeightOptimizer = Covariance_Optimization.WeightOptimization(BCOM_prices_df, scaled_daily_returns_df, positions_df)
    print(commodity_prices_df.index[1000])
    weights = WeightOptimizer.calculate_weights(commodity_prices_df.index[1000], alpha=100)
    print(weights)
